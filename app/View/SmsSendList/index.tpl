...
{html func=script url='view/smssendlist/smssendlist' charset="UTF-8"}
{html func=script url='view/smssendlist/smssend_list_validate' charset="UTF-8"}
...
<script>
	...
	/* 20160225 Edit by Giang : #6532 - refactor code - begin */
	/* #8298 add consentday */
	const TITLE_CONSENTDAY = "{/literal}{$headers['consentday']}{literal}";
</script>
{/literal}
		...
		<div class="modal-dialog" style="width: 1022px;">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form" id="form_add_list" method="post" action="{Router::url('', true)}" accept-charset="utf-8" enctype="multipart/form-data">
					<div class="form-group">
					<div class="err_msg_new_180" style="margin-left: 0px; text-align: center;">
						<div id="data_error_div"></div>
						<label class="error" id="err_create_list" style="margin-top: 7px; font-size: 1.2em;">{$msg_error}</label>
					</div>
					</div>
					<div class="form-group">
