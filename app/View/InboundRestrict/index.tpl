...
{html func=script url='view/inboundrestrict/inbound_restrict_ng_index' charset="UTF-8"}
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form" id="form_incoming_ng_list" method="post" action="{Router::url('', true)}" accept-charset="utf-8" enctype="multipart/form-data">
