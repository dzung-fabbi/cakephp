		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label class="col-sm-12 control-label temp_finish_alert" id="dialog_end_call-error"></label>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<input type="hidden" id="hdCallTimes3" name="data[T20OutSchedule][call_times]" value='{if isset($data.T20OutSchedule.call_times)}{$data.T20OutSchedule.call_times}{/if}'>
					</div>
				</div>
				<div class="row"></div>
				<div class="form-group">
					...
					<div class="col-xs-5">
						<select class="form-control pull-left" id="proc_num" name="data[T20OutSchedule][proc_num]">
							{foreach from=$proc_num item=values}
								<option value="{$values.M90PulldownCode.item_code}" {if isset($schedule) && $schedule.T20OutSchedule.proc_num eq $values.M90PulldownCode.item_code}selected{/if}>{$values.M90PulldownCode.item_name}</option>
							{/foreach}
						</select>
					</div>
				</div>
