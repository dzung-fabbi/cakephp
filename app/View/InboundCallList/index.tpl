...
{html func=script url='view/inboundcalllist/inbound_call_list_index' charset="UTF-8"}
...
<script>
	...
	const HIDDEN_CALLLIST = JSON.parse('{/literal}{$JSON_HiddenCallList}{literal}');//非表示項目
</script>
{/literal}
